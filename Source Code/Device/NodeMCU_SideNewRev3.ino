...
#define WIFI_SSID "ZTE_2.4G_LW9scU"
#define WIFI_PASSWORD "X3N4cZW7"
...
void loop() {
  ...
  if (Sr == true) {
    ...
    Firebase.setString("measurement_history/Devices/0420/"+ String(timestamp) +"/TotalDissolvedSolids", total_dissolved_solids);
